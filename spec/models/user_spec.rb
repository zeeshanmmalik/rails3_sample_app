...
describe User do
  ...
  it "should reject email addresses identical up to case" do
    ...
    user_with_duplicate_lowercase_email = User.new(@attr)
    user_with_duplicate_lowercase_email.should_not be_valid
  end
  ...
  describe "password validations" do
    ...
    it "should require a matching password" do
      unmatched_password_user = User.new(@attr.merge(:password => "password1", :password_confirmation => "password2"))
      unmatched_password_user.should_not be_valid
    end
